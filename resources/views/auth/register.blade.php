                ...
                <div class="col-sm-12 col-md-6 col-lg-6 offset-md-2 offset-lg-3">
                    <div class="card  w-100 p-2 mt-5 border-0">
                        <div class="card-body rounded-0 text-left pt-0 pb-2">
                            <h2 class="fw-600 display2-size mb-4"><span class="fa fa-edit"> Register</h2>
                            ...
                            <form action="{{ route('register') }}"  method=POST>
                                ...
                                <div class="col-sm-12 p-0 text-center">
                                    ...
                                    <h6 class="text-grey-500 font-xsss fw-500 mt-2 mb-4 lh-32">Register as Admin? <a href="{{ route('admin.register') }}" class="fw-700 ml-1" >Admin Registration</a></h6>
                                </div>
                            </form>
                        </div>
                    </div> 
